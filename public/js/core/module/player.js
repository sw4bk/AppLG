 ...
 Player = (function (Events) {
    ...
    $.extend(true, Player, Events, {
        ...
        initNative: function () {
            ...
            this.el.addEventListener('error', function (event) {
                var error = event;
                ...
                scope.onError(error.code, error.message);
            });
        },
        /**
        ...
        seek: function (position) {
            ...
            if (String(position).match(/\%/)) {
                // percent
                position = duration / 100 * parseFloat(position);
            }
        ...
        getDuration: function () {
            return this.el.seekable.end(0) * 1000;
        }
